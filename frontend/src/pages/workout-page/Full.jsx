...
export default function FullPlan() {
  ...
  const sortedPlan = fullPlan
    ? [...fullPlan].sort((a, b) => week.indexOf(a.day) - week.indexOf(b.day))
    : [];
            ...
            <tbody>
              {isRestDay ? (
                <tr>
                  ...
                  <td className="border-2 border-primary break-words">0</td>
                  <td className="border-2 border-primary break-words">0</td>
                </tr>
              ) : (
                plan.exercises.map((exercise, exerciseIndex) => (
                  <tr key={exerciseIndex}>
                    <th key={exerciseIndex}></th>
                    <td className="border-2 border-primary break-words">
