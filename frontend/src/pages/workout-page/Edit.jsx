...
export default function EditPlan() {
  ...
  function updateWorkout() {
    if (!selectedWorkout || !selectedDay) {
      alert(
        "You have made no selections please fill out the options below to continue",
      );
      return;
    }
  ...
  function deleteDay() {
    if (!selectedDay) {
      alert(
        "You have not selected a day to delete. Please select a day and try again.",
      );
      return;
    }
    ...
    setSelectedDay((prevDay) =>
      prevDay ? { ...prevDay, exercises: [] } : null,
    );
  }
